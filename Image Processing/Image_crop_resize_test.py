...
def browse_target_button():
    ...
    for f in files:
        ...
        #top
        #cropped_top = im.crop((0.231*w,0.1485*h,0.78467*w,0.9805*h)) # create a square cropped image
        cropped_top = im.crop((0.26033*w,0.3*h,0.676*w,0.8875*h))
        save_name_top = target_path + '/07_' + f.rstrip(".JPG") + "_" + str(myCounter) + ".JPG"
