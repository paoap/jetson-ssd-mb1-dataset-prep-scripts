...
h_div = 2
w_div = 2 # code is limited to 2 horizontal divisions
...
def browse_target_button():
    ...
    for f in files:
        ...
        for i in range(w_div):
            ...
            save_name_top = target_path + '/02_' + str(myCounter) + "_" + str(i) + ".JPG"
            ...
            save_name_bot = target_path + '/02_' + str(myCounter) + "_" + str(i+w_div) + ".JPG"
